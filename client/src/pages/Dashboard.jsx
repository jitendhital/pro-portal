...
import { FaCalendarAlt, FaClock, FaUser, FaMapMarkerAlt, FaHome, FaCheckCircle, FaTimesCircle, FaHourglassHalf } from 'react-icons/fa';
...
export default function Dashboard() {
  ...
  const [loading, setLoading] = useState({ seller: false, buyer: false });
  const [error, setError] = useState({ seller: '', buyer: '' });
