          ...
          {offerListings && offerListings.length > 0 && (
            <div className=''>
              <div className='my-3'>
                ...
                <Link className='text-sm text-emerald-600 hover:underline' to={'/search?offer=true'}>
                  Show more offers
                </Link>
              </div>
          ...
          {rentListings && rentListings.length > 0 && (
            <div className=''>
              <div className='my-3'>
                ...
                <Link className='text-sm text-emerald-600 hover:underline' to={'/search?type=rent'}>
          ...
          {saleListings && saleListings.length > 0 && (
            <div className=''>
              <div className='my-3'>
                ...
                <Link className='text-sm text-emerald-600 hover:underline' to={'/search?type=sale'}>
