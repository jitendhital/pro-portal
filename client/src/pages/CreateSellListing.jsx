...
/**
 * Create Sell Listing Page
 * Uses the MultiStepWizard component for sell-type listings
 */
export default function CreateSellListing() {
  ...
  useEffect(() => {
    const draft = localStorage.getItem('listing-draft-sell');
    if (draft) {
      try {
  ...
  const handleSubmit = async (formData) => {
    ...
    try {
      ...
      // Clear draft
      localStorage.removeItem('listing-draft-sell');
