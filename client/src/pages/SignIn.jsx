  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok || data.success === false) {
        setLoading(false);
        setError(data.message || res.statusText || "Sign in failed");
        return;
      }
        ...
        <div className="px-8 pb-8">
          ...
          <div className="mt-4">
            ...
            >
              ...
              >
                <path
                  d="M533.5 278.4c0-18.5-1.5-37-4.7-54.6H272v103.4h147.6c-6.4 34.6-25.6 63.9-54.6 83.5v69.4h88.1c51.6-47.6 81.4-117.5 81.4-201.7z"
                  fill="#4285F4"
                />
                <path
                  d="M272 544.3c73.7 0 135.6-24.4 180.8-66.1l-88.1-69.4c-24.5 16.5-55.9 26.3-92.8 26.3-71 0-131.4-47.9-153-112.4H29.5v70.6C74.8 480 167.6 544.3 272 544.3z"
                  fill="#34A853"
                />
                <path
                  d="M119 324.7c-10.8-32.4-10.8-67.1 0-99.5V154.6H29.5c-39.7 77.1-39.7 169 0 246.1L119 324.7z"
                  fill="#FBBC05"
                />
                <path
                  d="M272 107.7c39 0 74.3 13.5 102 40.1l76.3-76.3C403.2 24.9 339.7 0 272 0 167.6 0 74.8 64.3 29.5 154.6l89.5 70.6C140.6 155.6 201 107.7 272 107.7z"
                  fill="#EA4335"
                />
              </svg>
